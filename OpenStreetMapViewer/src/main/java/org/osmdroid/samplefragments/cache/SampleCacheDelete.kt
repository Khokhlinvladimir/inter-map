 ...
 */
class SampleCacheDelete : BaseSampleFragment(), View.OnClickListener, OnSeekBarChangeListener, TextWatcher {
    override val sampleTitle: String
        get() = "Cache Delete Area"
    ...
    private fun downloadJobAlert() {
        ...
        zoom_max!!.setOnSeekBarChangeListener(this@SampleCacheDelete)
        ...
        zoom_min!!.setOnSeekBarChangeListener(this@SampleCacheDelete)
        ...
        val cache_estimate = view.findViewById<TextView>(R.id.cache_estimate)
        ...
        try {
            if (cache_east != null && cache_west != null && cache_north != null && cache_south != null && zoom_max != null && zoom_min != null) {
                ...
                if (startJob) {
                    ...
                    val cacheManagerTask = mgr!!.cleanAreaAsync(requireActivity(), bb, zoommin, zoommax)
