 ...
 */
class SampleCacheDownloaderArchive : BaseSampleFragment(), View.OnClickListener, OnSeekBarChangeListener, TextWatcher {
    override val sampleTitle: String
        get() = "Cache Manager Archival"
    ...
    public override fun addOverlays() {
        ...
        mMapView!!.controller!!.setZoom(11)
        mMapView!!.controller!!.setCenter(GeoPoint(40.7, -73.9))
    }
    ...
    private fun updateEstimate(startJob: Boolean) {
        try {
            if (cache_east != null && cache_west != null && cache_north != null && cache_south != null && zoom_max != null && zoom_min != null && cache_output != null) {
                ...
                if (startJob) {
                    val outputName = Environment.getExternalStorageDirectory()
